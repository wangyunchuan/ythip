...
var inputName = '';
var inputValue = '';
class MaterialInventoryMain extends Component {
    constructor(props) {
        super(props);
        this.state = {
            serverIp:'',
...
export default class MaterialInventory extends Component{
    render(){
        return(
            <Navigator
                initialRoute={{name:'MaterialInventory',component:MaterialInventoryMain}}
                renderScene={
            (route, navigator) =>
             {
